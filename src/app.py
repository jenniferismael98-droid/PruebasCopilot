...
activities = {
    ...
    "Drama Club": {
        "description": "Rehearse scenes and prepare for school play performances",
        "schedule": "Tuesdays and Fridays, 3:45 PM - 5:15 PM",
        "max_participants": 20,
        "participants": ["isabella@mergington.edu", "benjamin@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Compete in science and engineering challenges with creative problem solving",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["emma@mergington.edu", "alex@mergington.edu"]
    },
    "Math League": {
        "description": "Practice math contests and work through challenging problem sets",
